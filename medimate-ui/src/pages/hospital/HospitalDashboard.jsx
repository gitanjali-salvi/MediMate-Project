...
// Import useNavigate to handle redirection after logout
...
const HospitalDashboard = () => {
  ...
  // (The rest of your component's logic for stats, filtering, and colors remains the same)
  const stats = {
